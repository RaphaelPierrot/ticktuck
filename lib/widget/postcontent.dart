  ...
  Widget build(BuildContext context) {
    return Stack(children: [
      VideoWidget(
        ...
        snappedPageIndex: widget.currentIndex,
        currentIndex: widget.snappedPageIndex,
      ),
      Column(
        children: [
          Expanded(
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          Text('@${widget.item.postedBy.username}',
                              style: TextStyle(
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(
                                  ...
                                  child: Marquee(
                                    text: "${widget.item.audioName}   •   ",
                                    velocity: 10,
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyLarge!
                                        .copyWith(color: tipo, fontSize: 15),
                                  )),
                            ],
                          ),
                          const SizedBox(
                    ...
                    children: [
                      ...
                      SocialButton(
                          icon: Icon(Icons.favorite,
                              color: socialButtonColor, size: 45),
                          number: widget.item.like),
                      SocialButton(
                          icon: Icon(Icons.comment,
                              color: socialButtonColor, size: 45),
                          number: widget.item.comment),
                      SocialButton(
                          icon: Icon(Icons.bookmark,
                              color: socialButtonColor, size: 45),
                          number: widget.item.bookmarks),
                      SocialButton(
                          icon: Icon(Icons.share,
                              color: socialButtonColor, size: 45),
                          number: widget.item.shared),
