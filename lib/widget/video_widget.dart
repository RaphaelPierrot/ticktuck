...
class VideoWidget extends StatefulWidget {
  ...
  State<VideoWidget> createState() =>
      _VideoWidgetState(videoUrl, currentIndex, snappedPageIndex);
}
...
class _VideoWidgetState extends State<VideoWidget> {
  ...
  _VideoWidgetState(this.videoUrl, this.currentIndex, this.snappedPageIndex);
  void _options() {
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    (widget.snappedPageIndex == widget.currentIndex && isPlaying)
        ? _controller.play()
        : _controller.pause();
